    ...
    <main className="min-h-screen bg-[#f3f5f2] text-[#142033]">
      ...
      <section className="mx-auto max-w-6xl space-y-10 px-6 py-10">
        ...
        <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          ...
          <Link href="/admin/county-data" className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200"><h2 className="text-xl font-bold">County Data Health</h2><p className="mt-2 text-sm leading-6 text-slate-600">County totals, missing fields, documents, and graphics checks.</p><span className="mt-4 inline-flex text-sm font-bold text-[#244f73]">Open module →</span></Link>
